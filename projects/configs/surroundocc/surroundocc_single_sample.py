...
data = dict(
    ...
    workers_per_gpu=1,  # Reduced workers for single sample
    train=dict(
        type=dataset_type,
        data_root=data_root,
    ...
    val=dict(type=dataset_type,
             data_root=data_root,
             ann_file='data/nuscenes_infos_val_filtered.pkl',
    ...
    test=dict(type=dataset_type,
              data_root=data_root,
              ann_file='data/nuscenes_infos_val_filtered.pkl',  # Will be replaced with mini dataset
              pipeline=test_pipeline, 
              occ_size=occ_size,
              pc_range=point_cloud_range,
              use_semantic=use_semantic,
