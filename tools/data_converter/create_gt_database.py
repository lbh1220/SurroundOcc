...
def create_airsim_dataset_script():
    """Standalone script to create AirSim occupancy ground truth."""
    import argparse
    
    parser = argparse.ArgumentParser(description='Create occupancy ground truth for AirSim dataset')
    parser.add_argument('--airsim-data-root', type=str, required=True,
                       help='Root directory of AirSim dataset')
    ...
    print('AirSim occupancy ground truth creation completed!')


if __name__ == '__main__':
    # Uncomment the following line to run the AirSim dataset creation script
    # create_airsim_dataset_script()
    pass
